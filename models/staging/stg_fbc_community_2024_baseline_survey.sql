...
-- Staging model for FBC Community 2024 baseline survey data
-- This model flattens the JSONB data and standardizes the structure

with fbc_community_2024_baseline_survey_data as (
    select
        -- Standard fields
        _id,
        end,
...
select * from fbc_community_2024_baseline_survey_data
