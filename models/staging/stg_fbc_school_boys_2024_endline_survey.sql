...
-- Staging model for FBC School Boys 2024 endline survey data
-- This model flattens the JSONB data and standardizes the structure

with fbc_school_boys_2024_endline_survey_data as (
    select
        -- Standard fields
        _id,
        end,
    ...
    from {{ source('survey_raw_data', 'fbc_school_boys_2024_endline_survey') }}
)

select * from fbc_school_boys_2024_endline_survey_data
