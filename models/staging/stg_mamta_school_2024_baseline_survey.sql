...
-- Staging model for Mamta School 2024 Baseline Survey with flattened JSONB data
-- This model flattens the JSONB data and standardizes the structure

with stg_mamta_school_2024_baseline_survey_data as (
    select
        ...
        'mamta_school_2024_baseline_survey' as source_table
        
    from {{ source('survey_raw_data', 'mamta_school_2024_baseline_survey') }}
    where data is not null
)

select * from stg_mamta_school_2024_baseline_survey_data
