...
-- Staging model for MAMTA School 2024 baseline survey data
-- This model flattens the JSONB data and standardizes the structure

with mamta_school_2024_baseline_survey_data as (
    select
        -- Standard fields
        _id,
        end,
...
select * from mamta_school_2024_baseline_survey_data
