...
-- Staging model for Msi Cs 2024 Endline Survey with flattened JSONB data
-- This model flattens the JSONB data and standardizes the structure

with stg_msi_cs_2024_endline_survey_data as (
    select
        ...
        'msi_cs_2024_endline_survey' as source_table
        
    from {{ source('survey_raw_data', 'msi_cs_2024_endline_survey') }}
    where data is not null
)

select * from stg_msi_cs_2024_endline_survey_data
