...
-- Staging model for Mamta School 2023 workshop long survey data
-- This model flattens the JSONB data and standardizes the structure

with mamta_school_2023_workshop_long_survey_data as (
    select
        -- Standard fields
        _id,
        end,
...
select * from mamta_school_2023_workshop_long_survey_data
