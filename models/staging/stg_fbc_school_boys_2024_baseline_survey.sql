...
-- Staging model for fbc_school_boys_2024_baseline_survey
-- This model flattens the JSONB data and standardizes the structure

with fbc_school_boys_2024_baseline_survey_data as (
    select
        -- Standard fields
        _id,
        "end",
...
select * from fbc_school_boys_2024_baseline_survey_data
