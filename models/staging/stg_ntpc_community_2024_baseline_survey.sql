...
-- Staging model for NTPC Community 2024 baseline survey data
-- This model flattens the JSONB data and standardizes the structure

with ntpc_community_2024_baseline_survey_data as (
    select
        -- Standard fields
        _id,
        end,
...
select * from ntpc_community_2024_baseline_survey_data
