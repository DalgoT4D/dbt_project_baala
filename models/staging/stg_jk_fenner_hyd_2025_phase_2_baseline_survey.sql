...
with stg_jk_fenner_hyd_2025_phase_2_baseline_survey as (
    select
        ...
        'jk_fenner_hyd_2025_phase_2_baseline_survey' as source_table
        
    from {{ source('survey_raw_data', 'jk_fenner_hyd_2025_phase_2_baseline_survey') }}
    where data is not null
)

select * from stg_jk_fenner_hyd_2025_phase_2_baseline_survey
