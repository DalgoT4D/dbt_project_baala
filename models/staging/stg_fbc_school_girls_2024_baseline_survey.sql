...
-- Staging model for FBC School Girls 2024 baseline survey data
-- This model flattens the JSONB data and standardizes the structure

with fbc_school_girls_2024_baseline_survey_data as (
    select
        -- Standard fields
        _id,
        end,
...
select * from fbc_school_girls_2024_baseline_survey_data
