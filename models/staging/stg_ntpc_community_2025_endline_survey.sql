...
-- Staging model for NTPC Community 2025 endline survey data
-- This model flattens the JSONB data and standardizes the structure

with ntpc_community_2025_endline_survey_data as (
    select
        -- Standard fields
        _id,
        end,
    ...
    from {{ source('survey_raw_data', 'ntpc_community_2025_endline_survey') }}
)

select * from ntpc_community_2025_endline_survey_data
