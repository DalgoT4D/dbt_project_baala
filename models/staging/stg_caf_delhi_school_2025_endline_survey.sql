...
-- Staging model for Caf Delhi School 2025 Endline Survey with flattened JSONB data
-- This model flattens the JSONB data and standardizes the structure

with stg_caf_delhi_school_2025_endline_survey_data as (
    select
        ...
        'caf_delhi_school_2025_endline_survey' as source_table
        
    from {{ source('survey_raw_data', 'caf_delhi_school_2025_endline_survey') }}
    where data is not null
)

select * from stg_caf_delhi_school_2025_endline_survey_data
