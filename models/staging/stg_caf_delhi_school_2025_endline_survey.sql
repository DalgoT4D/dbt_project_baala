...
-- Staging model for CAF Delhi School 2025 endline survey data
-- This model flattens the JSONB data and standardizes the structure

with caf_delhi_school_2025_endline_survey_data as (
    select
        -- Standard fields
        _id,
        end,
    ...
    from {{ source('survey_raw_data', 'caf_delhi_school_2025_endline_survey') }}
)

select * from caf_delhi_school_2025_endline_survey_data
