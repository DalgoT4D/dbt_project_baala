...
-- Staging model for Elephanta Community 2025 baseline survey data
-- This model flattens the JSONB data and standardizes the structure

with elephanta_community_2025_baseline_survey_data as (
    select
        -- Standard fields
        _id,
        end,
...
select * from elephanta_community_2025_baseline_survey_data
