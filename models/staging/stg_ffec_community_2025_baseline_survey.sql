...
-- Staging model for Ffec Community 2025 Baseline Survey with flattened JSONB data
-- This model flattens the JSONB data and standardizes the structure

with stg_ffec_community_2025_baseline_survey_data as (
    select
        ...
        'ffec_community_2025_baseline_survey' as source_table
        
    from {{ source('survey_raw_data', 'ffec_community_2025_baseline_survey') }}
    where data is not null
)

select * from stg_ffec_community_2025_baseline_survey_data
