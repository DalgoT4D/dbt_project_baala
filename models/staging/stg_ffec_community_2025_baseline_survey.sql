...
-- Staging model for FFEC Community 2025 baseline survey data
-- This model flattens the JSONB data and standardizes the structure

with ffec_community_2025_baseline_survey_data as (
    select
        -- Standard fields
        _id,
        end,
...
select * from ffec_community_2025_baseline_survey_data
