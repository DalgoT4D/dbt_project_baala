...
-- Staging model for Mosonie DC Project teachers 2025 baseline survey data
-- This model flattens the JSONB data and standardizes the structure

with mosonie_dc_project_teachers_2025_baseline_survey_data as (
    select
        -- Standard fields
        _id,
        end,
...
select * from mosonie_dc_project_teachers_2025_baseline_survey_data
