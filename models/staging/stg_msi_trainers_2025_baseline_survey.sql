...
-- Staging model for MSI Trainers 2025 baseline survey data
-- This model flattens the JSONB data and standardizes the structure

with msi_trainers_2025_baseline_survey_data as (
    select
        -- Standard fields
        _id,
        end,
...
select * from msi_trainers_2025_baseline_survey_data
