...
-- Staging model for CAF Ajmer students 2025 baseline survey data
-- This model flattens the JSONB data and standardizes the structure

with caf_ajmer_students_2025_baseline_survey_data as (
    select
        -- Standard fields
        _id,
        end,
...
select * from caf_ajmer_students_2025_baseline_survey_data
