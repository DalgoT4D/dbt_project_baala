...
-- Staging model for caf_ajmer_2024_baselineendline_survey
-- This model flattens the JSONB data and standardizes the structure

with caf_ajmer_2024_baselineendline_survey_data as (
    select
        -- Standard fields
        _id,
        end,
...
select * from caf_ajmer_2024_baselineendline_survey_data
