...
-- Staging model for Kokari Community 2025 Endline Survey with flattened JSONB data
-- This model flattens the JSONB data and standardizes the structure

with stg_kokari_community_2025_endline_survey_data as (
    select
        ...
        'kokari_community_2025_endline_survey' as source_table
        
    from {{ source('survey_raw_data', 'kokari_community_2025_endline_survey') }}
    where data is not null
)

select * from stg_kokari_community_2025_endline_survey_data
