...
with stg_elephanta_community_2025_endline_survey as (
    select
        ...
        'elephanta_community_2025_endline_survey' as source_table
        
    from {{ source('survey_raw_data', 'elephanta_community_2025_endline_survey') }}
    where data is not null
)

select * from stg_elephanta_community_2025_endline_survey
