...
-- Staging model for FBC Women Jhatingri baseline questionnaire data
-- This model flattens the JSONB data and standardizes the structure

with fbc_women_jhatingri_baseline_questionaire_data as (
    select
        -- Standard fields
        _id,
        end,
...
select * from fbc_women_jhatingri_baseline_questionaire_data
