...
-- Staging model for Baseline questionnaire data from Bareilly project
-- This model flattens the JSONB data and standardizes the structure

with baseline_questionnaire_bareilly_data as (
    select
        -- Standard fields
        _id,
        end,
...
select * from baseline_questionnaire_bareilly_data
