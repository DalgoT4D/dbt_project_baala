...
-- Staging model for Mamta School 2025 Endline Survey with flattened JSONB data
-- This model flattens the JSONB data and standardizes the structure

with stg_mamta_school_2025_endline_survey_data as (
    select
        ...
        'mamta_school_2025_endline_survey' as source_table
        
    from {{ source('survey_raw_data', 'mamta_school_2025_endline_survey') }}
    where data is not null
)

select * from stg_mamta_school_2025_endline_survey_data
