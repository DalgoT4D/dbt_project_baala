...
-- Staging model for MAMTA School 2025 endline survey data
-- This model flattens the JSONB data and standardizes the structure

with mamta_school_2025_endline_survey_data as (
    select
        -- Standard fields
        _id,
        end,
    ...
    from {{ source('survey_raw_data', 'mamta_school_2025_endline_survey') }}
)

select * from mamta_school_2025_endline_survey_data
