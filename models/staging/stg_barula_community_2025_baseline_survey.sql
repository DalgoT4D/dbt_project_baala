...
with stg_barula_community_2025_baseline_survey as (
    select
        ...
        'barula_community_2025_baseline_survey' as source_table
        
    from {{ source('survey_raw_data', 'barula_community_2025_baseline_survey') }}
    where data is not null
)

select * from stg_barula_community_2025_baseline_survey
