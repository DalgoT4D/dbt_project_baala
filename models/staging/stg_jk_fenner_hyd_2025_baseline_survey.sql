...
-- Staging model for Jk Fenner Hyd 2025 Baseline Survey with flattened JSONB data
-- This model flattens the JSONB data and standardizes the structure

with stg_jk_fenner_hyd_2025_baseline_survey_data as (
    select
        ...
        'jk_fenner_hyd_2025_baseline_survey' as source_table
        
    from {{ source('survey_raw_data', 'jk_fenner_hyd_2025_baseline_survey') }}
    where data is not null
)

select * from stg_jk_fenner_hyd_2025_baseline_survey_data
