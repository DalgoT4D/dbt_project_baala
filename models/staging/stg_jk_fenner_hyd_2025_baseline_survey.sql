...
-- Staging model for JK Fenner Hyderabad 2025 baseline survey data
-- This model flattens the JSONB data and standardizes the structure

with jk_fenner_hyd_2025_baseline_survey_data as (
    select
        -- Standard fields
        _id,
        end,
...
select * from jk_fenner_hyd_2025_baseline_survey_data
