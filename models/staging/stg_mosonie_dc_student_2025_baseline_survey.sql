...
-- Staging model for Mosonie Dc Student 2025 Baseline Survey with flattened JSONB data
-- This model flattens the JSONB data and standardizes the structure

with stg_mosonie_dc_student_2025_baseline_survey_data as (
    select
...
select * from stg_mosonie_dc_student_2025_baseline_survey_data
