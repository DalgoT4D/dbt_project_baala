...
-- Staging model for Tfi School 2024 Baseline Survey with flattened JSONB data
-- This model flattens the JSONB data and standardizes the structure

with stg_tfi_school_2024_baseline_survey_data as (
    select
        ...
        'tfi_school_2024_baseline_survey' as source_table
        
    from {{ source('survey_raw_data', 'tfi_school_2024_baseline_survey') }}
    where data is not null
)

select * from stg_tfi_school_2024_baseline_survey_data
