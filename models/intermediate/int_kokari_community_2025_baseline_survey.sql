...
-- Intermediate model for Kokari Community 2025 Baseline Survey with business logic and transformations
...
{% set rel = ref('stg_kokari_community_2025_baseline_survey') %}
