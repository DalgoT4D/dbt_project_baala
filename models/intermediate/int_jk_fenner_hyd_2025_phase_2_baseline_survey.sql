...
-- Intermediate model for jk_fenner_hyd_2025_phase_2_baseline_survey with business logic and transformations
...
{% set rel = ref('stg_jk_fenner_hyd_2025_phase_2_baseline_survey') %}
