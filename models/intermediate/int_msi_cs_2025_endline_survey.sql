{{
    config(
        materialized='table',
        tags=['intermediate', 'survey', 'endline']
    )
}}

-- Intermediate model for Msi Cs 2025 Endline Survey with business logic and transformations
...
{% set rel = ref('stg_msi_cs_2025_endline_survey') %}
