...
-- Intermediate model for Caf Ajmer Students 2025 Baseline Survey with business logic and transformations
...
{% set rel = ref('stg_caf_ajmer_students_2025_baseline_survey') %}
