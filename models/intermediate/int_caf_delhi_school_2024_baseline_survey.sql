{{
    config(
        materialized='table',
        tags=['intermediate', 'survey', 'baseline', 'school']
    )
}}

-- Intermediate model for Caf Delhi School 2024 Baseline Survey with business logic and transformations
...
{% set rel = ref('stg_caf_delhi_school_2024_baseline_survey') %}
