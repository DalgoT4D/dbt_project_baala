...
-- Intermediate model for Jakson Community 2024 Baseline Survey with business logic and transformations
...
{% set rel = ref('stg_jakson_community_2024_baseline_survey') %}
...
{% set colname_menst_mat = get_column_by_substring_postgres(rel, 'woman_material') %}
