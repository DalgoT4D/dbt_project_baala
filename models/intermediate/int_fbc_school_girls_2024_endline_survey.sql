{{
    config(
        materialized='table',
        tags=['intermediate', 'survey', 'endline', 'school', 'women']
    )
}}

-- Intermediate model for Fbc School Girls 2024 Endline Survey with business logic and transformations
...
{% set rel = ref('stg_fbc_school_girls_2024_endline_survey') %}
