{{
    config(
        materialized='table',
        tags=['intermediate', 'survey', 'baseline', 'endline']
    )
}}

-- Intermediate model for Caf Ajmer 2024 Baselineendline Survey with business logic and transformations
...
{% set rel = ref('stg_caf_ajmer_2024_baselineendline_survey') %}
